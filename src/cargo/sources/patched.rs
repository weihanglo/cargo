...
impl<'gctx> Source for PatchedSource<'gctx> {
    ...
    fn query(
        ...
        let dep_to_patch = dep
            .clone()
            .map_source(self.source_id, source_id_to_patch);
    ...
    fn fingerprint(&self, pkg: &Package) -> CargoResult<String> {
        ...
        let cksum = self.patch_checksum().full();
