...
Caused by:
  patch for `bar` in `https://github.com/rust-lang/crates.io-index` points to the same source, but patches must point to different sources.
  Check the patch definition in `[ROOT]/foo/.cargo/config.toml`.
...
[PATCHING] bar v1.0.0
[LOCKING] 1 package to latest compatible version
[COMPILING] bar v1.0.0 (patched registry (cksum=46806b943777e31efd3c0708a98bb6b19d369d3036766ef2b2f27d7c236ff68c))
...
[DOWNLOADED] bar v1.0.0 (registry `dummy-registry`)
[PATCHING] bar v1.0.0
[WARNING] patch `bar v2.0.0 (patched registry (cksum=e84fb4156c864f9372a3c0ebc53f8ee765cfd502ef84eb67a14d447490013adc))` was not used in the crate graph
...
[PATCHING] bar v1.0.0
[LOCKING] 1 package to latest compatible version
[COMPILING] bar v1.0.0 (patched registry (cksum=999bb70f0e374dc7c713e0c2a44147442f96ab022b9bc898235f2fd6cbd7b66d))
[COMPILING] foo v0.0.0 ([ROOT]/foo)
[FINISHED] `dev` profile [unoptimized + debuginfo] target(s) in [ELAPSED]s
[RUNNING] `target/debug/foo`
...
"#]])
    ...
    p.cargo("run -v")
        ...
        .with_stderr_data(str![[r#"
[UPDATING] `dummy-registry` index
[FRESH] bar v1.0.0 (patched registry (cksum=46806b943777e31efd3c0708a98bb6b19d369d3036766ef2b2f27d7c236ff68c))
...
[PATCHING] bar v1.0.0
[LOCKING] 1 package to latest compatible version
[ADDING] bar v1.0.0 (patched registry (cksum=[..]))
[COMPILING] bar v1.0.0 (patched registry (cksum=[..]))
[COMPILING] foo v0.0.0 ([ROOT]/foo)
[FINISHED] `dev` profile [unoptimized + debuginfo] target(s) in [ELAPSED]s
[RUNNING] `target/debug/foo`
...
[DOWNLOADED] bar v1.0.0 (registry `dummy-registry`)
[PATCHING] bar v1.0.0
[WARNING] patch `bar v1.0.0 (patched registry (cksum=46806b943777e31efd3c0708a98bb6b19d369d3036766ef2b2f27d7c236ff68c))` was not used in the crate graph
[HELP] Check that the patched package version and available features are compatible
      with the dependency requirements. If the patch has a different version from
      what is locked in the Cargo.lock file, run `cargo update` to use the new
      version. This may also occur with an optional dependency that is not enabled.
  ...
  "packages": [
    {
      ...
      "manifest_path": "[ROOT]/home/.cargo/patched-src/github.com-[HASH]/bar-1.0.0/[HASH]/Cargo.toml",
      "source": "patched+registry+https://github.com/rust-lang/crates.io-index?patch-cksum=46806b943777e31efd3c0708a98bb6b19d369d3036766ef2b2f27d7c236ff68c",
      "targets": [
        {
          "...": "{...}",
          "src_path": "[ROOT]/home/.cargo/patched-src/github.com-[HASH]/bar-1.0.0/[HASH]/src/lib.rs"
        }
      ]
    },
    "{...}"
...
[PATCHING] bar v1.0.0
[LOCKING] 1 package to latest compatible version
[COMPILING] bar v1.0.0 (patched registry (cksum=f315317fe27271f10b960a108f2747883151bd868aad776c2cb4524767c5aed8))
[COMPILING] foo v0.0.0 ([ROOT]/foo)
[FINISHED] `dev` profile [unoptimized + debuginfo] target(s) in [ELAPSED]s
[RUNNING] `target/debug/foo`
...
[UPDATING] git repository `[ROOTURL]/bar`
[LOCKING] 1 package to latest compatible version
[COMPILING] bar v1.0.0 (patched git (cksum=b0d23d812f651adb4e6ea78ffebc72a11c4f2b6aea5752622e02a7d25e294a54))
[COMPILING] foo v0.0.0 ([ROOT]/foo)
[FINISHED] `dev` profile [unoptimized + debuginfo] target(s) in [ELAPSED]s
[RUNNING] `target/debug/foo`
...
[CHECKING] foo v0.0.0 ([ROOT]/foo)
[FINISHED] `dev` profile [unoptimized + debuginfo] target(s) in [ELAPSED]s
[CHECKING] bar v1.0.0 (patched git (cksum=0f89441a985139201ea9e61f688459e271aa12bbf0db43882d15faf4040bd346))
[CHECKING] baz v1.0.0 (patched git (cksum=0f89441a985139201ea9e61f688459e271aa12bbf0db43882d15faf4040bd346))
